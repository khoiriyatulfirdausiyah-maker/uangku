...
if(!src.includes('UangKu v8.11 Performance Rebuild + Category Split + Manual Input Only + Theme + Daily Use Hardening'))throw new Error('v8.11 runtime header missing');
