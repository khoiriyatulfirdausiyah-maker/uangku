...
let qsa=0;
const dummy={classList:{toggle(){},add(){},remove(){}},style:{},dataset:{},textContent:'',value:'',innerHTML:'',onclick:null,onchange:null,onsubmit:null,onkeydown:null,click(){},focus(){},setAttribute(){},addEventListener(){},querySelectorAll(){qsa++;return[]},closest(){return null},scrollTo(){},clientWidth:320,scrollLeft:0,scrollHeight:0};
const storage={};
...
const demo={profile:{name:'Perf'},accounts,categories:['Makan & Minum','Penjualan','Lainnya'],categoryIcons:{},categoryGroups:{'Makan & Minum':'needs','Penjualan':'sales','Lainnya':'other'},transactions:tx,budgets:[{id:'b1',month:'2026-09',category:'Makan & Minum',limit:3000000}],goals:[],assets:{investment:[],property:[],physical:[]},debts:[],bills:[],routines:[],chat:[]};
...
assert(elapsed<2500,`renderHome benchmark slow: ${elapsed}ms`);
...
console.log(`performance-smoke: OK (${elapsed}ms / 15 home renders, txQSA=${txQ}, moreQSA=${moreQ})`);
