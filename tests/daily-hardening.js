...
eq(payload.appVersion,'8.5.0','backup app version');
...
assert(gradle.includes('versionCode 85'),'versionCode must be 83');
assert(gradle.includes('versionName "8.5.0"'),'versionName must be 8.3.0');
...
assert(workflow.includes('UangKu-v8.5-SIGNED-release-apk'),'signed artifact missing');
