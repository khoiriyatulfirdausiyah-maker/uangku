...
eq(payload.appVersion,'8.2.0','backup app version');
...
assert(gradle.includes('versionCode 82'),'versionCode must be 81');
assert(gradle.includes('versionName "8.2.0"'),'versionName must be 8.1.0');
...
assert(workflow.includes('UangKu-v8.2-SIGNED-release-apk'),'signed artifact missing');
